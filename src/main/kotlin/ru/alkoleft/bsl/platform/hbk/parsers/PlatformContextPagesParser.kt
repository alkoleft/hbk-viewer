...
package ru.alkoleft.bsl.platform.hbk.parsers
...
import ru.alkoleft.bsl.platform.hbk.parsers.specialized.ConstructorPageParser
import ru.alkoleft.bsl.platform.hbk.parsers.specialized.EnumPageParser
import ru.alkoleft.bsl.platform.hbk.parsers.specialized.EnumValuePageParser
import ru.alkoleft.bsl.platform.hbk.parsers.specialized.MethodPageParser
import ru.alkoleft.bsl.platform.hbk.parsers.specialized.ObjectPageParser
import ru.alkoleft.bsl.platform.hbk.parsers.specialized.PropertyPageParser
...
class PlatformContextPagesParser(
    ...
    private fun <T> parsePage(
        ...
        try {
            ...
            throw PlatformContextLoadException(
                "Не удалось разобрать страницу документации ${page.title}(${page.htmlPath})",
                ex,
            )
        }
    }
