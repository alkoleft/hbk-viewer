...
package ru.alkoleft.bsl.platform.hbk.exceptions
...
/**
 * Исключение, возникающее при ошибке парсинга описания страницы.
 *
 * @param message Сообщение об ошибке парсинга
 */
class PageDescriptionParsingError(
    message: String,
) : HbkParsingException("Ошибка разбора описания страницы: $message")
