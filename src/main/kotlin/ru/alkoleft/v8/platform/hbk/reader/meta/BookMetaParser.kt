 ...
 * @see ru.alkoleft.v8.platform.hbk.reader.toc.Tokenizer для токенизации содержимого
 * @see ru.alkoleft.v8.platform.hbk.reader.toc.PeekableIterator для навигации по токенам
 */
